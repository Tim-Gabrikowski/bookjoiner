		...
		return {
			...
			author:
				item.volumeInfo.authors != null
					...
					: "",
			publisher:
				item.volumeInfo.publisher != null ? item.volumeInfo.publisher : "",
			year:
			...
			isbn:
				isbn13 != null
					...
					? isbn10.identifier
					: "",
			pages: item.volumeInfo.pageCount != null ? item.volumeInfo.pageCount : -1,
			description:
				item.volumeInfo.description != null ? item.volumeInfo.description : "",
			image:
